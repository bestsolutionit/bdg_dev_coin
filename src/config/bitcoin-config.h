...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Micro Bitcoin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Micro Bitcoin"
...
#define PACKAGE_BUGREPORT "https://github.com/MBCproject/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Micro Bitcoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Micro Bitcoin 0.15.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "micro-bitcoin"
